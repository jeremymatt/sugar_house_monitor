...
server, Tank Pi, Pump Pi, Display Pi, and O2 Pi using the templates in config/example/.
"""
...
def main() -> None:
    ...
    default_base = "https://mattsmaplesyrup.com/sugar_house_monitor"
